...
date_label = tk.Label(root, text="Today's date: " + date.strftime("%B %d, %Y"), font=("Helvetica", 14))
date_label.pack(pady=5)

# Username Input
userrow = tk.Label(root, text="Username:", bg="black", fg="white")
userrow.pack(pady=5)
userrow_entry = tk.Entry(root, width=30)
userrow_entry.pack(pady=5)

# Password Input
passrow = tk.Label(root, text="Password:", bg="black", fg='white')
passrow.pack(pady=5)
passrow_entry = tk.Entry(root, show="*", width=30)
passrow_entry.pack(pady=5)

tries = 0

# Create a button
enter_button = tk.Button(root, text="Enter", font=("Helvetica", 16), command=login)
